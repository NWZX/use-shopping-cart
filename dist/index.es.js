import react_1, { createContext, useReducer, useEffect, useMemo, useContext, useDebugValue } from 'react';
...
function useStorageState(storage, key, defaultState) {
    ...
    var _a = react_1.useState(common.useInitialState(storage, key, defaultState)), state = _a[0], setState = _a[1];
...
function useStorageReducer$1(storage, key, reducer, defaultInitialArg, defaultInit) {
    ...
    var _a = react_1.useReducer(addForceStateActionToReducer(reducer), common.useInitialState(storage, key, defaultState)), state = _a[0], dispatch = _a[1];
...
function CartProvider({
  ...
  return (
    react_1.createElement(CartContext.Provider, { value: contextValue, __self: this, __source: {fileName: _jsxFileName, lineNumber: 93}}, children)
  )
}
...
function DebugCart(props) {
  ...
  const cartPropertyRows = Object.entries(cart)
    ...
    .map(([key, value]) => (
      react_1.createElement('tr', { key: key, __self: this, __source: {fileName: _jsxFileName, lineNumber: 189}}
        , react_1.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 190}}, key)
        , react_1.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 191}}
          , typeof value === 'object' ? (
            react_1.createElement('button', { onClick: () => console.log(value), __self: this, __source: {fileName: _jsxFileName, lineNumber: 193}}, "Log value" )
          ) : (
  ...
  return (
    react_1.createElement('table', {
      ...
      , react_1.createElement('thead', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 215}}
        , react_1.createElement('tr', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 216}}
          , react_1.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 217}}, "Key")
          , react_1.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 218}}, "Value")
        )
      )
      , react_1.createElement('tbody', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 221}}, cartPropertyRows)
    )
  )
}
